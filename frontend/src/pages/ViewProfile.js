          ...
          <MDBCol lg="4">
            <MDBCard className="mb-4">
              <MDBCardBody className="text-center">
                ...
                <p className="text-muted mb-4">{user.portfolio}</p>
                <div className="d-flex justify-content-center mb-2">
                  <MDBBtn outline className="ms-1" href='/Profile'>Edit Profile</MDBBtn>
                </div>
              </MDBCardBody>
            </MDBCard>
          </MDBCol>
            ...
            <MDBCard className="mb-4">
              <MDBCardBody>
                <MDBRow>
                  ...
                  <MDBCol sm="9">
                    <MDBCardText className="text-muted">{user.about}</MDBCardText>
                  </MDBCol>
                </MDBRow>
                <hr />
                <MDBRow>
                ...
                <MDBRow>
                  ...
                  <MDBCol sm="9">
                    <MDBCardText className="text-muted">{user.skills}</MDBCardText>
                  </MDBCol>
                </MDBRow>
                <hr />
                <MDBRow>
